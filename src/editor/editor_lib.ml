...
let save_testhaut testhaut id =
  match Learnocaml_local_storage.(retrieve (editor_state id)) with
    ...
    let new_exo = {metadata;incipit;prepare;solution;question;template;test;prelude;checkbox;mtime} in
            ...
            (fun question_id quest acc ->  
              ...
              (div ~a:[a_id ("button_delete")] [
                  ...
                  Manip.Ev.onclick button
                    ...
                    (div ~a:[a_id ("up")] [
                     let buttonUp = button ~a:[a_id question_id]
                                              [img ~src:("icons/icon_down_dark.svg") ~alt:"" () ; pcdata "" ] in 
                  ...
                  (div ~a:[a_id ("down")] [
                     let buttonDown = button ~a:[a_id question_id]
                                                [img ~src:("icons/icon_up_dark.svg") ~alt:"" () ; pcdata "" ] in 
                  ...
                  (div ~a:[a_id ("duplicate")] [
                       let buttonDuplicate = button ~a:[a_id question_id]
                                                       [img ~src:("icons/icon_list_dark.svg") ~alt:"" (); pcdata "" ] in
...
(** Update the list of couples and then return this list and the monomorphic type that must be used *)
...
let rec genTemplate chaine = if chaine = "" then ""
